...
use crate::{DEFAULT_NAMESPACE, block::Block};
...
#[derive(Default)]
pub struct ChunkGrid(pub HashMap<IVec3, Arc<Chunk>>);
...
impl Chunk {
    ...
    pub fn to_block_coord(raw_coordinate: i32) -> i16 {
        (raw_coordinate % SIZE_I32 + SIZE_I32) as i16
    }
